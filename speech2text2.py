...
model_file_path = './_data/deepspeech-0.9.3-models.pbmm'  # Replace with the path to the model file
print('Loading model...'+model_file_path)
model = deepspeech.Model(model_file_path)

scorer_file_path = './_data/deepspeech-0.9.3-models.scorer' 
...
audio_file = './_data/converted.wav'
